...
:-consult('C:/Users/Carlo/Documents/NetBeansProjects/ProgettoICSE/src/fileProlog/decomposizioneCholesky/KB/versione2/control_dependence_Cholesky_v2.pl').
:-consult('C:/Users/Carlo/Documents/NetBeansProjects/ProgettoICSE/src/fileProlog/decomposizioneCholesky/KB/versione2/data_dependence_Cholesky_v2.pl').
:-consult('C:/Users/Carlo/Documents/NetBeansProjects/ProgettoICSE/src/fileProlog/decomposizioneCholesky/KB/versione2/db_Syntax_Cholesky_v2.pl').
...
calcolo_coefficienti_Cholesky(MatriceA, MatriceU, Dim) :-
		% CICLO CHE SCORRE LE RIGHE -----------------------------
	ciclo_for(
				ID_1, % ciclo for 1
				Variabile_1, % i
				uguaglianza(Init_CicloFor_Row,Uguaglianza_ref_1,Classe,Metodo), % = 0
				less(Exit_CicloFor_Row,Less_ref_1,Less_ref_2,Classe,Metodo), % < n
				post_incr(Incr_CicloFor_Row,Post_incr_ref_1,Classe,Metodo), % i++
				Classe,
				Metodo
			),
	...
	ciclo_for(
				...
				Variabile_2, % j
				uguaglianza(Init_CicloFor_Temp_1,Uguaglianza_ref_2,Classe,Metodo), % = 0
				less_equal(Exit_CicloFor_Temp_1,Less_ref_3,Less_ref_4,Classe,Metodo), % <= i
				post_incr(Incr_CicloFor_Temp_1,Post_incr_ref_2,Classe,Metodo), % j++
				Classe,
				Metodo
			),
	...
	ciclo_for(
				...
				Variabile_3, % k
				uguaglianza(Init_CicloFor_Temp_2,Uguaglianza_ref_3,Classe,Metodo), % = 0
				less(Exit_CicloFor_Temp_2,Less_ref_5,Less_ref_6,Classe,Metodo), % < j
				post_incr(Incr_CicloFor_Temp_2,Post_incr_ref_3,Classe,Metodo), % k++
				Classe,
				Metodo
			),
...
decomposizone_di_Cholesky(MatriceA, MatriceU) :- 
	...
	% controllo calcolo coefficienti di Cholesky
	calcolo_coefficienti_Cholesky(MatriceA, MatriceU, N).
